OC.L10N.register(
    ...
    "Moodle admin options saved" : "Moodle rendszergazdai beállítások mentve",
    "Failed to save Moodle admin options" : "Moodle rendszergazdai beállítások mentése sikertelen",
    "Your password is not stored. It is just used once to get an access token which will be used to interact with your Moodle account." : "Jelszavát nem tároljuk. Csak egyszer használjuk egy hozzáférési token megszerzésére, amelyet a továbbiakban a Moodle-fiókkal való interakcióhoz használunk.",
    "Moodle instance address" : "Moodle példány címe",
    "Moodle instance URL" : "Moodle példány URL-je",
    "Moodle login" : "Moodle bejelentkezés",
    "Your user name" : "Az Ön felhasználó neve",
    ...
    "Warning, everything you type in the search bar will be sent to your Moodle instance." : "Figyelem, mindent elküldünk a Moodle példányához, amit a keresősávba ír.",
    "Moodle options saved" : "A Moodle beállításai mentve",
    "Failed to save Moodle options" : "A Moodle-beállítások mentése sikertelen",
    "Successfully connected to Moodle!" : "Sikeresen csatlakozott a Moodle-hez!",
    "Failed to authenticate to Moodle" : "Nem sikerült a Moodle hitelesítés",
    "No Moodle account connected" : "Nincs csatlakoztatva Moodle fiók",
    "Error connecting to Moodle" : "Hiba történt a Moodle-hoz való csatlakozáskor",
